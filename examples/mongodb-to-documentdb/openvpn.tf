...
#  ec2_security_group_rules = []
  ...
  openvpn_s3_lifecycle_configuration_rules   = null
...
module "openvpn_nat_routing_script" {
  source  = "registry.terraform.io/SevenPico/openvpn/aws//modules/nat-routing-script"
  version = "5.0.4"
  context = module.openvpn_context.self
...
module "openvpn_ssl_config_script" {
  source     = "registry.terraform.io/SevenPico/openvpn/aws//modules/ssl-config-script"
  version    = "5.0.4"
  context    = module.openvpn_context.self
...
# Duplicate in the Private Zone For access while Connected to VPN
resource "aws_route53_record" "openvpn_nlb_private" {
  count   = module.openvpn_context.enabled ? 1 : 0
